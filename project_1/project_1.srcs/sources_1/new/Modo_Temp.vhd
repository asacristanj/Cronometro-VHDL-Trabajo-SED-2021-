...
begin
    if Enable_sel='1' then
        code1<=std_logic_vector(to_unsigned(unit_sec_aux,code1'length));
        code2<=std_logic_vector(to_unsigned(dec_sec_aux,code1'length));
        code3<=std_logic_vector(to_unsigned(unit_min_aux,code1'length));
        code4<=std_logic_vector(to_unsigned(dec_min_aux,code1'length));
    end if;
end process;
